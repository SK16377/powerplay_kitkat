 ...
 */
@Autonomous(name = "RIGHT_AUTO", group = "COMP")
@Disabled
public class Right_Auto_FSM extends LinearOpMode {
   ...
   // Pose2d startPose = new Pose2d(15, 10, Math.toRadians(180));
    ...
    public void runOpMode() throws InterruptedException {
        ...
        //turn
        double turnAngle2 = Math.toRadians(-135); //135
        ...
        Trajectory HIGH_HEADING = drive.trajectoryBuilder(BACKCONES.end())
                .lineToLinearHeading(new Pose2d(34,-15,Math.toRadians(135)))
                .build();

        Trajectory HIGH2 = drive.trajectoryBuilder(HIGH_HEADING.end())
                .lineTo(new Vector2d(26,-4.5))
                .build();
        ...
        //turn
        double turnAngle3 = Math.toRadians(-48); //-50
