 ...
 */
@Autonomous(name = "Right_AUTO_NEW", group = "COMP")
@Disabled

public class Right_AutoSAVED extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory LINE1 = drive.trajectoryBuilder(START.end())
                .lineToLinearHeading(new Pose2d(36.61, -13.71, Math.toRadians(0.00)))
                .build();

        Trajectory CONES1 = drive.trajectoryBuilder(LINE1.end())
                .lineToLinearHeading(new Pose2d(56.00, -17.00, Math.toRadians(0.00)))
                .build();
        Trajectory SLOWCONES1 = drive.trajectoryBuilder(CONES1.end())
                .lineToLinearHeading(new Pose2d(63.50,-17.00,Math.toRadians(0.0)))
                .build();

        Trajectory DELIVER1 = drive.trajectoryBuilder(CONES1.end(),true)
                .splineTo(new Vector2d(35.00, -21.50), Math.toRadians(-152.48))
                .build();

        Trajectory CONES2 = drive.trajectoryBuilder(DELIVER1.end())
                .splineTo(new Vector2d(56.00, -16.00), Math.toRadians(0.00))
                .build();

        Trajectory SLOWCONES2 = drive.trajectoryBuilder(CONES2.end())
                .lineToLinearHeading(new Pose2d(63.50,-16.00,Math.toRadians(0.0)))
                .build();

        Trajectory DELIVER2 = drive.trajectoryBuilder(CONES2.end(),true)
                .splineTo(new Vector2d(35.00, -21.00), Math.toRadians(-154.48))
                .build();

        Trajectory CONES3 = drive.trajectoryBuilder(DELIVER2.end())
                .splineTo(new Vector2d(58.00, -15.50), Math.toRadians(0.00))
                .build();

        Trajectory SLOWCONES3 = drive.trajectoryBuilder(CONES3.end())
                .lineToLinearHeading(new Pose2d(64.00,-15.50,Math.toRadians(0.0)))
                .build();
        ...
        Trajectory CONES4 = drive.trajectoryBuilder(DELIVER3.end())
                .splineTo(new Vector2d(58.54, -14.50), Math.toRadians(0.00))
                .build();

        Trajectory SLOWCONES4 = drive.trajectoryBuilder(CONES3.end())
                .lineToLinearHeading(new Pose2d(64.5,-14.50,Math.toRadians(0.0)))
                .build();

        Trajectory DELIVER4 = drive.trajectoryBuilder(CONES4.end(),true)
                .splineTo(new Vector2d(35.00, -19.75), Math.toRadians(-154.48))
                .build();
        ...
        Trajectory PARK_A2 = drive.trajectoryBuilder(PARK_A.end())
                .lineToLinearHeading(new Pose2d(14,-12.00,Math.toRadians(0)))
                .build();
                        ...
                        if (!drive.isBusy()) {
                            ...
                            else //TODO:auto code
                            {
                                ...
                                if(tagOfInterest.id == 0)
                                {
                                    ...
                                    drive.followTrajectoryAsync(PARK_A2);
