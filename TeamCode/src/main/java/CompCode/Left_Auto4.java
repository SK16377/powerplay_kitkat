 ...
 */
@Autonomous(name = "LEFT_AUTO one plus 3" , group = "COMP")
public class Left_Auto4 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory START = drive.trajectoryBuilder(startPose)
                .lineToLinearHeading(new Pose2d(-37,-19.00, Math.toRadians(198.00)))
                .build();
...
//                .build();
        ...
        TrajectorySequence LINE_AND_CONES1 = drive.trajectorySequenceBuilder(START.end())
                .lineToLinearHeading(new Pose2d(-36.61, -7.00, Math.toRadians(180.00)))
                .lineToLinearHeading(new Pose2d(-65.0, -8.50, Math.toRadians(180.00)))
                .build();
...
//                .build();
        ...
        Pose2d newPose1 = new Pose2d(-65.0, -8.5,LINE_AND_CONES1.end().getHeading());

        //drive.setPoseEstimate(newPose1);
        //TODO RELOCALAIZE
        Trajectory DELIVER1 = drive.trajectoryBuilder(newPose1,true)
                .splineTo(new Vector2d(-34.00, -15.50), Math.toRadians(-32.48))
                .build();

        Trajectory CONES2 = drive.trajectoryBuilder(DELIVER1.end())
                .splineTo(new Vector2d(-65.0, -8), Math.toRadians(180.00))
                .build();

        Pose2d newPose2 = new Pose2d(-65.00, -8,CONES2.end().getHeading());
        ...
        Trajectory CONES3 = drive.trajectoryBuilder(DELIVER2.end())
                .splineTo(new Vector2d(-65.50, -6.5), Math.toRadians(180.00))
                .build();

        Pose2d newPose3 = new Pose2d(-65.0, -7,CONES3.end().getHeading());


        Trajectory DELIVER3 = drive.trajectoryBuilder(newPose3,true)
                .splineTo(new Vector2d(-34.00, -15.2), Math.toRadians(-32.48))
                .build();

        Trajectory CONES4 = drive.trajectoryBuilder(DELIVER2.end())
                .splineTo(new Vector2d(-65.0, -8.00), Math.toRadians(180.00))
                .build();

        Pose2d newPose4 = new Pose2d(-65.0, -8,CONES4.end().getHeading());
        ...
        TrajectorySequence PARK_C = drive.trajectorySequenceBuilder(DELIVER3.end())
                .lineTo(new Vector2d(-26.07, -11.01))
                .splineToLinearHeading(new Pose2d(-7.63, -13.00, Math.toRadians(0.00)), Math.toRadians(13.55))
        ...
        TrajectorySequence PARK_A = drive.trajectorySequenceBuilder(DELIVER4.end())
                .splineTo(new Vector2d(-64.0, -8.00), Math.toRadians(180.00))
