 ...
 */
@Autonomous(name = "RRIGHT_AUTO one plus 3" , group = "COMP")
public class Right_Auto4 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory START = drive.trajectoryBuilder(startPose)
                .lineToLinearHeading(new Pose2d(35,-18.00, Math.toRadians(348.00)))
                .build();
...
//                .build();
        ...
        TrajectorySequence LINE_AND_CONES1 = drive.trajectorySequenceBuilder(START.end())
                ...
                .lineToLinearHeading(new Pose2d(64.00, -10.00, Math.toRadians(0.00)))
                .build();
